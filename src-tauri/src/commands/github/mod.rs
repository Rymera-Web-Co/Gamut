...
mod remote;
use remote::{
    https_host, is_github_asset_host, parse_owner_repo, parse_pr_url, split_remote,
    ssh_alias_resolves_to_github,
};
...
#[cfg(test)]
mod tests {
    use super::{normalize_base, parse_next_link, DEFAULT_API};
