...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::repo::git_branch_create,
            commands::config::git_config_overview,
            commands::config::git_config_set_identity,
            commands::config::git_config_set_remote_url,
            commands::config::git_config_set_branch_upstream,
            commands::cleanup::list_stale_branches,
            commands::cleanup::delete_branches,
            commands::cleanup::delete_local_branch,
            ...
            commands::sync::git_pull_many,
            commands::sync::git_pull_ff_many,
            commands::sync::git_push,
            commands::sync::git_push_many,
            ...
            commands::worktree::git_worktree_prune,
            ...
            commands::github::github_collaborators,
            commands::github::github_remove_review_request,
            commands::github::github_add_assignees,
            commands::github::github_remove_assignees,
